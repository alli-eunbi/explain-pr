...
.flowchart-value{display:grid;grid-template-columns:30px minmax(0,1fr);gap:8px;margin-top:6px;font-size:calc(14px * var(--fc-scale));line-height:1.55}.flowchart-value-label{color:#7b8d96;font-size:12px;padding-top:2px}.flowchart-value.output{font-weight:600;color:#194658}
